        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-red-100 rounded-full mb-4">
            <svg className="w-6 h-6 text-red-600" fill="currentColor" viewBox="0 0 20 20">
              <path d="M17.5 1H2.5A1.5 1.5 0 001 2.5v15A1.5 1.5 0 002.5 19h15a1.5 1.5 0 001.5-1.5v-15A1.5 1.5 0 0017.5 1z" />
              <path d="M10 5l-3 6h6l-3-6z" fill="white" />
            </svg>
          </div>
          ...
          <p className="text-gray-600 text-sm mt-2">
            {mode === 'sign-in'
              ? 'Sign in to manage your YouTube channel'
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          {mode === 'sign-in' ? (
            <>
              ...
              <a href="/sign-up" className="text-red-600 hover:text-red-700 font-medium">
                Sign up
              </a>
            </>
          ) : (
